CREATE  TABLE IF NOT EXISTS `sotm_article_x_tag` (
...
INDEX `fk_sotm_article_x_tag_tag_id` (`tag_id` ASC),
INDEX `indx_deleted` (`is_deleted` ASC, `date_deleted` ASC),
INDEX `indx_edited` (`is_edited` ASC, `date_modified` ASC),
CONSTRAINT `fk_sotm_article_x_tag_article_id`
FOREIGN KEY (`article_id` )
REFERENCES `sotm_articles` (`id` )
ON DELETE CASCADE,
CONSTRAINT `fk_sotm_article_x_tag_tag_id`
FOREIGN KEY (`tag_id` )
