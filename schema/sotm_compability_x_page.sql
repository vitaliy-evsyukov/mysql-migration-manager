CREATE  TABLE IF NOT EXISTS `sotm_compatibility_x_page` (
`compatibility_id` INT(11) UNSIGNED NOT NULL COMMENT 'Идентификатор подбора',
...
PRIMARY KEY (`compatibility_id`, `product_id`, `page_num`),
...
CONSTRAINT `fk_sotm_compatibility_x_page__compability_product`
FOREIGN KEY (`compatibility_id`, `product_id` )
REFERENCES `sotm_product_x_compatibility` (`compatibility_id`, `product_id` ),
CONSTRAINT `fk_sotm_compatibility_x_page__compatibility_id`
